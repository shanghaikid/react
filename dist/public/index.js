    ...
    _createClass(TextInputView, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                tooltip = message === '' ? {} : _defineProperty({}, 'data-tooltip', message);
            ...
            return _react2.default.createElement(
                'div',
                _extends({ className: cls }, tooltip),
                _react2.default.createElement('input', { 'data-tooltip': 'test', ref: function ref(input) {
